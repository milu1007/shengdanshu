...
function unlockAudioContext() {
    console.log('尝试解锁音频上下文，当前状态：', listener.context.state);
    if (listener.context.state ==='suspended') {
        ...
        unlockSource.start();
        unlockSource.stop();
        console.log('音频上下文解锁后状态：', listener.context.state);
    }
}
...
function loadAudio(i) {
    ...
    loader.load(file, function (buffer) {
        ...
        console.log('音频加载进度：' + (xhr.loaded / xhr.total * 100) + '%');
    });
}
